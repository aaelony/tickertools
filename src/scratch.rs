// Scratch / reference experiment: a vanilla RNN + LSTM trained on random
// integer sequences (next-token prediction). Not part of the ticker pipeline
// and not called from main; kept for reference.
#![allow(dead_code)]
